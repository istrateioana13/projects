    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_question', models.CharField(db_index=True, max_length=255, verbose_name='Întrebare')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer_text', models.CharField(max_length=255, verbose_name='Răspuns')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_quiz', models.CharField(default='Chestionar Nou', max_length=100, verbose_name='Titlul chestionarului')),
